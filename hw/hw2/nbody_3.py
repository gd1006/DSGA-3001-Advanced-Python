"""
    ...
    This change decreased the time of the script from 162.107 seconds to 160.538 seconds.
    speedup: 162.107/160.538 = 1.00977
    fourth best improvement
"""
import time
import timeit
...
def advance(BODY, dt):
    ...
    seenit = []
    for body1 in BODY.keys():
        for body2 in BODY.keys():
