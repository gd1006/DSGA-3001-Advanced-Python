"""
    ...
    This change decreased the time of the script from 162.107 seconds to 157.537 seconds.
    speedup: 162.107/157.537 = 1.02901
...
def advance(dt):
    ...
    '''
    bodies_pairs = itertools.combinations(BODIES, 2)
